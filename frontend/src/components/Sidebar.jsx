...
export default function Sidebar() {
  ...
  return (
    <aside
      className="glass flex flex-col transition-all duration-300 ease-in-out relative z-10"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-white/5">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="font-bold text-sm text-slate-100 leading-none">Duka CRM</p>
      ...
      <button
        ...
        className="mx-2 mb-4 p-2.5 rounded-xl text-slate-500 hover:text-slate-300 hover:bg-white/5 transition-all flex items-center justify-center"
      >
